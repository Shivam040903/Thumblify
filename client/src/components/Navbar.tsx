        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    {
                        isLoggedIn? <Link to='/my-generation' className="hover:text-pink-300 transition">My Generation
                    </Link>
                ...
                <div className="flex items-center gap-2">
                    {isLoggedIn ? (
                        <div className="relative group">
                            ...
                            <div className="absolute hidden group-hover:block top-6
                            right-0 pt-4">
                        ...
                        <button onClick={()=> navigate('/login')} className="hidden md:block px-6 py-2.5 bg-pink-600 hover:bg-pink-700 
                        active:scale-95 transition-all rounded-full">Get Started</button>
                    )}
            ...
            <div className={`fixed inset-0 z-100 bg-black/40 backdrop-blur flex flex-col items-center justify-center text-lg gap-8 md:hidden transition-transform duration-400 ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                { isLoggedIn? <Link onClick={() => setIsOpen(false)} to='/my-generation'>My Generation
                </Link>
